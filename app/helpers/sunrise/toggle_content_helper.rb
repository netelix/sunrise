  ...
  module ToggleContentHelper
    def toggle_button_show(
      ...
      html_class = {
        ...
        'class' =>
          "#{toggler_class} show-button collapse #{
            'show' unless content_visible
          }"
      }
    ...
    def toggle_button_hide(
      ...
      html_class = {
        ...
        'data-toggle' => 'collapse',
        'class' =>
          "#{toggler_class} hide-button collapse #{'show' if content_visible}"
      }
    ...
    def toggle_content(toggler_class, content_visible = true, &block)
      content_tag 'div',
                  class:
                    "#{toggler_class} collapse #{'show' if content_visible}",
                  &block
    end
  end
end
